    ...
    return (
        <div className={`max-w-7xl mx-auto md:mt-5 flex flex-col items-start gap-2 max-[640px]:mt-5`}>
            ...
            <div className="max-[640px]:mt-2 flex gap-3">
                ...
                <a href="/adnan-fr.pdf" target="_blank" class="relative inline-flex items-center justify-start px-4 py-2 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group" target="_blank" rel="noopener noreferrer">
