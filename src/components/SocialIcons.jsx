    ...
    return (
        <div className={`max-w-7xl mx-auto md:mt-5 flex flex-col items-start gap-2 max-[640px]:mt-5`}>
            ...
            <div className="max-[640px]:mt-2 flex gap-3">
                <a href="https://www.facebook.com/profile.php?id=100015302744231&mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" aria-label="Facebook profile" className="w-8 h-8 relative overflow-hidden rounded-full bg-blue-500 group transition-all duration-500 hover:scale-110 flex items-center justify-center">
                ...
                <a href="https://api.whatsapp.com/send?phone=923408752827" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp chat" className="w-8 h-8 relative overflow-hidden rounded-full bg-green-500 group transition-all duration-500 hover:scale-110 flex items-center justify-center">
                    <svg className="relative z-10 transition-all duration-300 fill-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 72 72" fill="none">
                ...
                <a href="https://www.linkedin.com/in/adnan-yousaf-ab1585255?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile" className="w-8 h-8 relative overflow-hidden rounded-full bg-blue-600 group transition-all duration-500 hover:scale-110 flex items-center justify-center">
